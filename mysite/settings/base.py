...
SECRET_KEY = os.environ.get('DJANGO_PAGE_SECRET_KEY')
...
TEMPLATES = [
    {
        ...
        # Looks for Django backend templates at template folders.
        # This way it is possible to customize Django built-in backend templates.
